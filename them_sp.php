...
// Tự động kiểm tra và thêm cột mo_ta nếu ông giáo chưa chạy lệnh SQL
...
if (isset($_POST['btn_them'])) {
    ...
    $mo_ta = $conn->real_escape_string($_POST['mo_ta']); // Lấy dữ liệu mô tả từ form
    $gia = $_POST['gia_tien'];
    $kho = $_POST['so_luong'];
    ...
    // Câu lệnh SQL thêm mo_ta vào danh sách cột và giá trị
...
<body class="bg-light p-5">
    <div class="container bg-white p-4 shadow-sm rounded" style="max-width: 650px;">
        <h2 class="text-center mb-4 text-primary">THÊM MỚI LINH KIỆN</h2>
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="mo_ta" class="form-control" rows="3" placeholder="Nhập thông số kỹ thuật, ghi chú..."></textarea>
            </div>
            ...
            <div class="d-flex gap-2">
                <button name="btn_them" class="btn btn-primary w-100 fw-bold">THÊM VÀO KHO</button>
